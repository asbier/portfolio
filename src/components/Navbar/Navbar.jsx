  ...
  return (
    <>
      ...
      <header className="fixed left-0 w-full z-50 bg-[#F1F2E5]/90 backdrop-blur-sm bottom-0 lg:top-0 lg:bottom-auto h-[110px] lg:h-[120px] border-t lg:border-t-0 lg:border-b border-black/5">
        <div className="flex flex-col lg:flex-row justify-between items-center px-0 lg:px-6 h-full max-w-[1800px] mx-auto overflow-hidden"> 
          <div className="w-full lg:flex-1 lg:max-w-[50%] overflow-hidden whitespace-nowrap h-[40px] flex items-center border-b lg:border-none border-black/5 px-6 lg:px-0">
            <motion.div 
              animate={{ x: [0, -1000] }} 
          ...
          <nav className="flex space-x-2 lg:space-x-4 items-center w-full lg:w-auto justify-between lg:justify-end h-[70px]">
            ...
            <div className="flex items-center space-x-2 pr-6 lg:pr-0">
              <a href="mailto:mail@annemaris.de" className="px-5 py-2 lg:px-8 lg:py-3 text-[10px] lg:text-2xl font-semibold uppercase rounded-full bg-[#FFB115] border border-black/10 text-[#D9D9D9] lg:bg-[#FFB115] lg:border-black/10 lg:text-[#D9D9D9] font-neue-semibold">Contact</a>
