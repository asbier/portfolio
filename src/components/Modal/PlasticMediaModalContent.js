...
const PlasticMediaModalContent = () => (
  <div className="modal-content-container">
    ...
    <p><strong>"WE LIVE ONLINE, YET ARE ADDICTED TO THE SMELL OF FRESHLY PRINTED MAGAZINE PAGES. WE IMMERSE OURSELVES IN NEW AND NICHE TRENDS, WHILE WE STRATEGIZE WITH A COMMERCIAL AWARENESS. WE ARE DEEPLY ROOTED IN OUR LOCAL COMMUNITY, WHILST ALSO WORKING WITH THE VERY BEST OF INTERNATIONAL TEAMS. HELLO, THIS IS PLASTIC MEDIA." ©PLASTIC MEDIA</strong></p>

    <p className="role-description">
      Here I had my first design-related experiences with international customer contact. Under the mentorship of Art Director Daniela Bily and Creative Director Kira Stachowitz, I learned how to channel my skills and creativity within the realms of editorial design, brand marketing, and public relations.
    </p>
    ...
    <section className="modal-section">
      <h2>INDIE & Material Girl Magazine</h2>
      <p>INDIE Magazine is a renowned independent fashion and culture publication that originally started in Austria before relocating to Berlin. Founded by Plastic Media and Kira Stachowitz (Creative Head), along with Clemens Steinmüller (Chapter Magazine), the magazine quickly gained international recognition for its bold aesthetics, avant-garde storytelling, and fresh take on youth culture.</p>
    ...
    <section className="modal-section">
      <h2>Monki Magazine</h2>
      <p>We created the Monki Magazines, developing editorial content and visual design that captured the brand's youthful, experimental spirit.</p>
    ...
    <section className="modal-section">
      ...
      <ul className="checklist">
        <li>Designed four issues of INDIE Magazine</li>
        <li>Created Material Girl Magazine content</li>
        <li>Developed Monki Magazine editorial design</li>
        <li>Gained international customer contact experience</li>
        <li>Learned editorial design and brand marketing</li>
      </ul>
    </section>

    <p>
      <a href="https://www.heroes-heroines.com/" target="_blank" rel="noopener noreferrer">
        ➞ Learn more about Plastic Media
      </a>
    </p>
  </div>
);
