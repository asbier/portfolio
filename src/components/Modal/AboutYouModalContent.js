...
const AboutYouModalContent = () => (
    <div className="aboutyou-modal-content-container">
        <h2> About You</h2>
            ...
            <h1>Barometer of Shit to Good</h1>
  <div class="barometer-container">
    <div class="barometer-scale"></div>
    <div class="barometer-needle"></div>
  </div>
  <div class="labels">
    <span>💩 Total Shit</span>
    <span>🤷 Meh</span>
    <span>🎉 Amazing</span>
  </div>
  <button onclick="setBarometer(20)">Set to Shit</button>
  <button onclick="setBarometer(50)">Set to Meh</button>
  <button onclick="setBarometer(80)">Set to Amazing</button>
