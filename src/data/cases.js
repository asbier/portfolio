export const cases = [
  {
    ...
    description: "Rebranding SumUp Retail for Europe — a design system, clearer product differentiation, and art direction for a coherent market rollout.",
    challenge: "Retail touchpoints across Europe needed one visual language without losing local relevance. The brand had to feel consistent at scale while making SumUp’s retail offer unmistakably distinct.",
    impact: "Defined a scalable design system, sharpened how the product stands apart in market, and set art direction for a unified European rollout — from core identity through to retail experience.",
  ...
  },
  {
    ...
    hideTitleTag: true,
    tags: ["EDITED", "REBRAND", "DIVERSITY & INCLUSION"],
  ...
  },
   {
    ...
    impact: "A bold, festival-ready poster that leans into “bad taste” as strategy: glamorous, absurd, and confrontational. More stories in that vein have been told in the mediums of books and film since — the kind of story that was normally the preserve of independent art-house publishers has also hit Hollywood. If Jovana's work inspired Greta Gerwig's Barbie — who knows? A key visual that held its own at the festival and beyond — unapologetic, provocative, right in the middle of that conversation.",
  ...
  },
  {
    ...
    description: "PLASTIC MEDIA is an independent magazine for cutting-edge fashion, music, opinion, and culture. Based in Vienna in 2015, it is now based in Berlin. Published biannually in print.",
    challenge: "Creating the concept for a new issue of INDIE, including collage illustrations and layout.",
